...
TwoWire::TwoWire(unsigned char wire_num)  {
	_wire_num = wire_num;
}
...
void TwoWire::begin(void) {
	...
	case 0:
		xSysCtlPeripheralEnable2(WIRE_BASE);
		xSysCtlPeripheralEnable2(WIRE_PORT_BASE);
		_wire_base = WIRE_BASE;

		xSPinTypeI2C(PERIPHERAL_WIRE_SCL, PIN_WIRE_SCL);
		xSPinTypeI2C(PERIPHERAL_WIRE_SDA, PIN_WIRE_SDA);

		xI2CMasterInit(_wire_base, 400000);
		break;
#endif
#if WIRE_INTERFACES_COUNT > 1
	case 1:
		xSysCtlPeripheralEnable2(WIRE1_BASE);
		xSysCtlPeripheralEnable2(WIRE1_PORT_BASE);
		_wire_base = WIRE1_BASE;

		xSPinTypeI2C(PERIPHERAL_WIRE1_SCL, PIN_WIRE1_SCL);
		xSPinTypeI2C(PERIPHERAL_WIRE1_SDA, PIN_WIRE1_SDA);
	...
	case 2:
		xSysCtlPeripheralEnable2(WIRE2_BASE);
		xSysCtlPeripheralEnable2(WIRE2_PORT_BASE);
		_wire_base = WIRE2_BASE;

		xSPinTypeI2C(PERIPHERAL_WIRE2_SCL, PIN_WIRE2_SCL);
		xSPinTypeI2C(PERIPHERAL_WIRE2_SDA, PIN_WIRE2_SDA);
	...
	case 3:
		xSysCtlPeripheralEnable2(WIRE3_BASE);
		xSysCtlPeripheralEnable2(WIRE3_PORT_BASE);
		_wire_base = WIRE3_BASE;

		xSPinTypeI2C(PERIPHERAL_WIRE3_SCL, PIN_WIRE3_SCL);
		xSPinTypeI2C(PERIPHERAL_WIRE3_SDA, PIN_WIRE3_SDA);
...
//	TWI_StartRead(twi, address, 0, 0);
	xI2CMasterReadBufS1(_wire_base, txAddress, rxBuffer, quantity, xtrue);
//	do {
...
uint8_t TwoWire::endTransmission(uint8_t sendStop) {
	...
	xI2CMasterWriteBufS1(_wire_base, txAddress, txBuffer, txBufferLength, xtrue);
